module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        publicDir: 'web/bundles/app',
        baseAssetsDir: 'src/Gallery/AppBundle/Resources/assets',
        faFontsDir: '<%= baseAssetsDir %>/components/font-awesome/fonts',
        coffeeDir: '<%= baseAssetsDir %>/coffeescript',
        ...
        copy: {
            ...
            js: {
                files: [
                    ...
                    {
                        src: ['<%= componentsDir %>/magnific-popup/dist/jquery.magnific-popup.min.js'],
                        dest: '<%= jsDir %>/vendor/magnific-popup.js'
                    },
                    {
